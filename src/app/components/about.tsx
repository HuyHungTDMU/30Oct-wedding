        ...
        <div className="mt-36 flex text-center flex-col justify-center items-center">
            ...
            <div className='flex items-center justify-center gap-10 mt-10'>
                <div className='flex flex-col gap-2 items-center justify-center'>
                    ...
                    <span className='text-[#703B2B] text-2xl mt-3'>Hoàng Huy Hùng</span>
                </div>

                <span className='text-[#703B2B] pb-16 text-2xl'>˚ʚ♡ɞ˚</span>
                ...
                <div className='flex flex-col gap-2 items-center justify-center'>
                    ...
                    <span className='text-[#703B2B] text-2xl mt-3'>Lê Thị Thiên Kiều</span>
                </div>
            </div>
        </div>
    )
