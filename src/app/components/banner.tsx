...
export default function Banner() {
    ...
    return (
        <div className='relative'>
            <img className='h-screen w-screen object-center object-cover' src='/DSC06624-1.jpg'
                 alt='banner'/>
            {/*<img className='z-0 h-screen w-screen object-center object-cover' src='/DSC06624-2.jpg'*/}
            {/*     alt='banner'/>*/}
            <div
